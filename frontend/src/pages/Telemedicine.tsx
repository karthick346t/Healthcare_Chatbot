        ...
        <div className="h-[calc(100vh-6rem)] flex gap-6 pb-6">
            ...
            <div className="flex-1 flex flex-col gap-4">
                <div className="flex-1 bg-neutral-900 rounded-3xl overflow-hidden relative shadow-2xl border border-neutral-800 group">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-neutral-800 to-neutral-900 text-white">
                            {connecting ? (
                                <div className="flex flex-col items-center animate-pulse">
                                    <div className="w-24 h-24 rounded-full border-4 border-themeAccent-500 border-t-transparent animate-spin mb-6"></div>
                                ...
                                <div className="text-center space-y-6">
                                    <div className="relative inline-block">
                                        <img src={doctor.avatar} alt={doctor.name} className="w-32 h-32 rounded-full border-4 border-themeAccent-500 shadow-lg object-cover" />
                                    ...
                                    <div>
                                        ...
                                        <p className="text-themeAccent-400 font-medium">{doctor.specialty}</p>
                                    </div>
                                    <div className="bg-neutral-800/50 backdrop-blur-sm px-6 py-4 rounded-2xl max-w-sm mx-auto border border-white/10">
                                        ...
                                        <button 
                                            ...
                                            className="w-full py-3 bg-gradient-to-r from-themeAccent-500 to-blue-600 rounded-xl font-bold hover:shadow-lg hover:shadow-themeAccent-500/30 transition-all active:scale-95"
                                        >
                                            Join Consultation
                                        </button>
                                    </div>
                    ...
                    <div className="absolute top-6 right-6 w-48 aspect-video bg-black rounded-xl overflow-hidden shadow-2xl border-2 border-white/10 transition-all hover:scale-105 hover:border-themeAccent-500/50">
                        {cameraOn ? (
                             <Webcam 
                                audio={false}
                                mirrored={true}
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-neutral-800 text-neutral-500 dark:text-neutral-400">
                    ...
                    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-neutral-900/80 backdrop-blur-xl px-6 py-3 rounded-2xl flex items-center gap-4 border border-white/10 shadow-2xl transition-all hover:bg-neutral-900/90">
                        ...
                        <div className="w-px h-8 bg-white dark:bg-[#1f232b]/20 mx-2"></div>
                        <button 
                            onClick={() => setShowChat(!showChat)}
                            className={`p-4 rounded-xl transition-all ${showChat ? 'bg-themeAccent-500 text-white shadow-lg shadow-themeAccent-500/30' : 'bg-neutral-800 text-white hover:bg-neutral-700'}`}
                        >
            ...
            <div className={`transition-all duration-300 flex flex-col gap-4 ${showChat ? 'w-80 opacity-100' : 'w-0 opacity-0 overflow-hidden'}`}>
                <div className="flex-1 bg-white dark:bg-[#1f232b] rounded-3xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
                    <div className="p-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                        <h3 className="font-bold text-neutral-700 dark:text-neutral-200">Consultation Chat</h3>
                        <div className="w-2 h-2 rounded-full bg-green-500"></div>
                    </div>
                    <div className="flex-1 p-4 overflow-y-auto space-y-4">
                        <div className="flex gap-2">
                            <img src={doctor.avatar} className="w-8 h-8 rounded-full object-cover" />
                            <div className="bg-gray-100 rounded-2xl rounded-tl-none p-3 text-sm text-neutral-600 dark:text-neutral-300">
                    ...
                    <div className="p-3 border-t border-gray-100">
                        <div className="relative">
                            <input 
                                ...
                                className="w-full pl-4 pr-10 py-3 rounded-xl bg-gray-50 border-none focus:ring-2 focus:ring-themeAccent-500 outline-none text-sm"
                            />
                            <button className="absolute right-2 top-2 p-1.5 bg-themeAccent-500 text-white rounded-lg hover:bg-themeAccent-600 transition-all">
                                <HiChat />
                            </button>
                        </div>
                    </div>
                ...
                {/* Notes Panel */}
                <div className="h-48 bg-white dark:bg-[#1f232b] rounded-3xl shadow-sm border border-gray-100 p-4">
                    <h3 className="font-bold text-neutral-700 dark:text-neutral-200 mb-2 text-sm flex items-center gap-2">
                        <HiInformationCircle className="text-themeAccent-500" /> Quick Notes
                    </h3>
                    <textarea 
                        className="w-full h-full resize-none outline-none text-sm text-neutral-600 dark:text-neutral-300 bg-transparent placeholder-gray-300"
